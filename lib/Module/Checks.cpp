...
llvm::PreservedAnalyses DivCheckPass::run(Module &M, ModuleAnalysisManager &AM) {
  ...
  // TODO: definitely excessive
  return PreservedAnalyses::none();
}

llvm::PreservedAnalyses OvershiftCheckPass::run(Module &M, ModuleAnalysisManager &AM) {
